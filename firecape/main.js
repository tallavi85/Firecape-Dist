...
var map = {
	"./landing/calc.module": [
		...
		"default~landing-calc-module~landing-landing-module",
		"landing-calc-module"
	],
...
/***/ "./src/app/shared/lazy-service.service.ts":
/*!************************************************!*\
  !*** ./src/app/shared/lazy-service.service.ts ***!
  \************************************************/
...
var LazyService = /** @class */ (function () {
    function LazyService(httpClient) {
        this.httpClient = httpClient;
    }
    LazyService.prototype.requestGet = function (url, headers) {
        return this.httpClient.get(url, headers);
    };
    LazyService.prototype.requestPost = function (url, body, headers) {
        return this.httpClient.post(url, body, headers);
    };
    LazyService.prototype.requestDelete = function (url, headers) {
...
/* harmony import */ var _lazy_service_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./lazy-service.service */ "./src/app/shared/lazy-service.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule.forRoot = function () {
        return {
            ...
            providers: [_lazy_service_service__WEBPACK_IMPORTED_MODULE_22__["LazyService"]]
        };
    };
    var SharedModule_1;
...
module.exports = __webpack_require__(/*! C:\Users\Tal\Desktop\4\firecape-master\portal\src\main.ts */"./src/main.ts");
